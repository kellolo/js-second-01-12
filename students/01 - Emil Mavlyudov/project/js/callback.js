...
let url = 'https://raw.githubusercontent.com/lindoro7/js-second-01-12/master/students/01%20-%20Emil%20Mavlyudov/responses/catalogData.json';
...
class ProdList {
    ...
    fetchGoods(callback) {
        let xhr = makeGETRequest(`${url}`, (goods) => {
