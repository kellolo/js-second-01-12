...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/build/build/js/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/build/build/js/cart-item.js":
/*!*****************************************!*\
  !*** ./src/build/build/js/cart-item.js ***!
  \*****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _product__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product */ \"./src/build/build/js/product.js\");\n\nvar catalog = {\n  components: {\n    item: _product__WEBPACK_IMPORTED_MODULE_0__[\"default\"]\n  },\n  template: \" \\n    <div class=\\\"productsPage\\\" id=\\\"bodyShop\\\">\\n    <item v-for=\\\"item in catalogItems\\\" v-bind:key=\\\"item.id\\\" v-bind:item=\\\"item\\\"></item>\\n    </div>\\n    \",\n  data: function data() {\n    return {\n      CatURL: '/catalogData.json',\n      catalogItems: []\n    };\n  },\n  methods: {},\n  mounted: function mounted() {\n    var _this = this;\n\n    this.$root.getData(this.CatURL).then(function (data) {\n      _this.catalogItems = data;\n    });\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (catalog);\n\n//# sourceURL=webpack:///./src/build/build/js/catalog.js?");

/***/ }),

/***/ "./src/build/build/js/feedback.js":
/*!****************************************!*\
  !*** ./src/build/build/js/feedback.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart */ \"./src/build/build/js/cart.js\");\n/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./catalog */ \"./src/build/build/js/catalog.js\");\n/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search */ \"./src/build/build/js/search.js\");\n/* harmony import */ var _feedback__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./feedback */ \"./src/build/build/js/feedback.js\");\n\n\n\n\nvar bodyShop = {\n  el: '#E-Shop',\n  components: {\n    cart: _cart__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n    catalog: _catalog__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n    search: _search__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n    'feed-back-form': _feedback__WEBPACK_IMPORTED_MODULE_3__[\"default\"]\n  },\n  data: {\n    openMenu: false\n  },\n  methods: {\n    getData: function getData(url) {\n      return fetch(url).then(function (data) {\n        return data.json();\n      });\n    },\n    allFetch: function allFetch(url, type, data) {\n      // метод для отправки данных на сервер\n      return fetch(url, {\n        method: type,\n        headers: {\n          'Content-Type': 'application/json'\n        },\n        body: data\n      }).then(function (data) {\n        return data.json();\n      });\n    }\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (bodyShop);\n\n//# sourceURL=webpack:///./src/build/build/js/mainHomeWork.js?");

/***/ }),

/***/ "./src/build/build/js/product.js":
/*!***************************************!*\
  !*** ./src/build/build/js/product.js ***!
  \***************************************/
/*! exports provided: default */
